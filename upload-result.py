...
try:
    ...
    while 1:
        ...
        if not line:
            break
        tc_id, tc_result, tc_exec_time = line.strip('\n').split()
        print(tc_id + " : " + tc_result + " : " + tc_exec_time)
        ...
        reportToTestlink(int(tc_id), tc_result[0].lower(), tc_exec_time, platform_desktop_id)
finally:
    ffile.close()
